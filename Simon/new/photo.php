        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="messagesDropdown">
            ...
            <a class="dropdown-item" href="#">
              ...
              <div class="dropdown-message small">Vous avez 0 messages</div>
            </a>
          ...
          <div class="dropdown-menu" aria-labelledby="alertsDropdown">
            ...
            <a class="dropdown-item" href="#">
              <span class="text-success">
                <strong>
                  <i class="fa fa-long-arrow-up fa-fw"></i>Profil à jour</strong>
              </span>
             
              <div class="dropdown-message small">Vous avez 0 nouvelles notifications</div>
            </a>
            <div class="dropdown-divider"></div>
...
<?php 
    ...
    $u=$_SESSION["utilisateur_id"]-1;
    
$reponse= $bdd->prepare('SELECT * FROM photo WHERE utilisateur_id= :utilisateur_id ');
$reponse->execute(array('utilisateur_id'=>$u));

//$repons = $bdd->query('SELECT * FROM photo ');
            ...
            <div class="card-body">
               <div class="form-row">  
				   <div class="col-md-12">
				      <center>
                <?php  
                     echo' <img src="'.$donnees['url'].'" class="image" alt="philippe" width="110"/>';
                      ?>
