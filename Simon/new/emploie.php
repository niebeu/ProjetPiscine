  ...
  <!-- Bouton Emploi-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="emploie.php">Emploie</a>
          <a href="ajouteremploie.php">Proposer un emploi</a>
        </li>
      </ol>   
...
<?php 
                    ...
                    $reponse = $bdd->query('SELECT * FROM emploie ORDER BY id_emploie DESC');
        ...
        <div class="card card-register mx-auto mt-5">
            <div class="card-body">
               <div class="form-row">
				   ...
				   <div class="col-md-4">
				      <h7><?php echo $donnees["nomp"];  ?></h7><br>
                   ...
                   <div class="col-md-8"><br><br>
                       <div><div class="card card-login mx-auto mt-1">
                        <center> 
                       <label>Propose un nouvel emploi sur LinkECE:</label>
                        </center>
                           </div>
                        </div><br>
