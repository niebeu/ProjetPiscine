...
<?php 
                   ...
                   // $reponse = $bdd->query('SELECT * FROM utilisateur WHERE utilisateur.suivre="oui" '); 
                      $t=$_SESSION["utilisateur_id"]-1;

                      $reponse = $bdd->prepare('SELECT * FROM utilisateur WHERE utilisateur.suivre="oui" AND (utilisateur.utilisateur_id != :ui ) AND utilisateur.type != "ADMINISTRATEUR"');
