      ...
      <div class="card-body">
        <form method="post" action="supprimer.php">
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" name="name" placeholder="Entrer le nom">
          </div>
          <div class="form-group">
        ...
        <div>
          <button class="btn btn-primary btn-block" type="submit" name="submit" value="Envoyer">Envoyer</button></div> <br>
            <div><a class="btn btn-primary btn-block" href="login.html">Retour</a></div>
